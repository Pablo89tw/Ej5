...
public class Listar_Alumno_x_Materia_iF extends javax.swing.JInternalFrame {
    ...
    public Listar_Alumno_x_Materia_iF() {
        initComponents();
        armarCabecera();
    }
    ...
    private void jTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldKeyReleased
        borrarFila1();
        for (Materia m1 : aD.buscarMateria(jTextField.getText(), "NOMBRE")) {
